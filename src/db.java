...
public class db extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    ResultSet result1 = st1.executeQuery("select sum(amount) as total, sDate, Sales_Persons.fName, Sales_Persons.lName, Branch.bName from Sales, Sales_Persons, Branch where Sales.personId = Sales_Persons.personId and Sales.branchId = Branch.branchId group by Sales.branchId, Sales.sDate order by sDate desc ");

	    ResultSet result = st.executeQuery("select productName, quantity, amount, sDate, Sales_Persons.fName, Sales_Persons.lName, Branch.bName from Sales, Sales_Persons, Branch where Sales.personId = Sales_Persons.personId and Sales.branchId = Branch.branchId order by sDate desc");
